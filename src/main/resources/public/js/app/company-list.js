(function() {
  ...
  var CompanyListRow = React.createClass({
    ...
    render: function() {
      return (
        <tr className="companyRow danger text-primary">
          ...
          <td>
            ...
            <button className="btn btn-danger btn-sm btn-rightOf-inline" onClick={this.handleAddOwnersButtonClick}>Add Owners</button>
          </td>
        </tr>
        );
    }
      ...
      return (
        ...
        <div className="companyList">
          <table className="table table-bordered">
            <thead>
              <tr className="success text-danger">
                <th>Name</th>
                <th>Address</th>
                <th>City</th>
                <th>Country</th>
